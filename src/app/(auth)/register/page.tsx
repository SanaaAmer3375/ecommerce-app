...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  if (res?.error) {
    if (res.error.includes("EMAIL_EXISTS")) {
    ...
    <div className="min-h-screen bg-bg flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl border border-gray-100 p-8 w-full max-w-md shadow-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted text-sm mt-1">Join us and start shopping</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex items-center gap-3 bg-bg border border-gray-200 rounded-lg px-4 py-3 focus-within:border-primary transition-colors">
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-primary text-white py-3 rounded-lg font-medium hover:bg-primary-dark transition-colors disabled:opacity-70"
          >
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-text-muted text-xs">Or sign up with</span>
          <div className="flex-1 border-t border-gray-200" />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 border border-gray-200 py-3 rounded-lg text-sm font-medium text-text hover:bg-bg transition-colors"
          >
